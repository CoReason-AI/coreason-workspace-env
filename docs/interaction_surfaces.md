...
- **WebSocket CLI Client**: Developers can use `coreason interact` to subscribe natively to LangGraph events via WebSockets, rendering a dynamic, collapsing Accordion task tree directly in the terminal without requiring a web browser.
